...
public class Client {
	public static void main(String[] args) {
		...
		Market marketNikkei = new Market("Nikkei");
		IPO.enterNewStock(marketNikkei, "BABA", "Alibaba", 84.88);
		IPO.enterNewStock(marketNikkei, "BDU", "Baidu", 253.66);

		marketNikkei.printStocks();
